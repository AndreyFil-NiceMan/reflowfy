"""
Shared reusable destination definitions for E2E tests.

Demonstrates the @destination decorator pattern — these destinations can be
imported and reused across multiple test pipelines.

All destinations use explicit keyword arguments for full IDE autocomplete.
"""

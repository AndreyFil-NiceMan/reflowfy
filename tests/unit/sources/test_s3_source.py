        ...
        page1 = {
            "Contents": [
                {"Key": "data/file1.json", "Size": 100, 
                 "LastModified": datetime.now(), "ETag": '"a"'},
                {"Key": "data/file2.json", "Size": 100,
                 "LastModified": datetime.now(), "ETag": '"b"'},
            ]
        }
        page2 = {
            "Contents": [
                {"Key": "data/file3.json", "Size": 100,
                 "LastModified": datetime.now(), "ETag": '"c"'},
            ]
        }
